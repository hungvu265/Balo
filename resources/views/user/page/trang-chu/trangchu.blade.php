                                            ...
                                            <div class="product-thumbnail">
                                                ...
                                                <div class="product-action-grid clearfix">
                                                    <input type="hidden" name="_token" value="{{csrf_token()}}">
                                                        <div>
                                                            <button style = "background: #1E90FF;border-radius: 25px " class="button_wh_40 btn_view right-to xemnhanh" data-toggle="modal" data-target="#xemNhanh" data-id_product="{{$sps->id}}" data-id_img="{{$sps->san_pham->id}}">
                                                ...
                                                <div class="product-box">
                                                    <div class="product-thumbnail">
                                                        ...
                                                        <div class="product-action-grid clearfix">
                                                            <input type="hidden" name="_token" value="{{csrf_token()}}">
                                                                <div>
                                                                    <button style = "background: #1E90FF;border-radius: 25px " class="button_wh_40 btn_view right-to xemnhanh" data-toggle="modal" data-target="#xemNhanh" data-id_product="{{$spm->id}}" data-id_img="{{$spm->san_pham->id}}">
                                                                        <i style="color: #fff;"class="fa fa-search"></i>
                                                                        <span style="color: white">Xem nhanh</span>
                                                                    </button>
                                                                </div>
                                                    ...
                                                    <div class="product-box">
                                                        <div class="product-thumbnail">
                                                            ...
                                                            <div class="product-action-grid clearfix">
                                                                <input type="hidden" name="_token" value="{{csrf_token()}}">
                                                                <div>
                                                                    <button style = "background: #1E90FF;border-radius: 25px " class="button_wh_40 btn_view right-to xemnhanh" data-toggle="modal" data-target="#xemNhanh" data-id_product="{{$sp->id}}" data-id_img="{{$sp->san_pham->id}}">
                                                                        <i style="color: #fff;"class="fa fa-search"></i>
                                                                        <span style="color: white">Xem nhanh</span>
                                                                    </button>
                                                                </div>
