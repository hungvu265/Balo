        ...
        <div class="col-md-12">
            ...
            <div class="row" style="background: cadeblue; padding: 15px">
                ...
                <div class="col-md-6" style="text-align: center; color: #000; font-weight: bold; font-size: 30px">
                    <h4 style="margin:0">Shop Balo, túi xách .vn</h4>
                ...
                <p style="color: #000; font-weight: bold">Mọi chi tiết liên hệ website tại: <a href="http://127.0.0.1:8000/">.VN</a>, hoặc liên hệ qua số hotline: 0343754517. Xin cảm ơn quý khách đã mua hàng shop chúng tôi.</p>
            </div>
        </div>
    </div>
</body>
