            ...
            <div class="rowx">
                <div class="col-lg-6 col-md-6 col-sm-6 hidden-xs top_content_">
                    <ul class="contact_top">
                        ...
                        <li class="li_contact"><span><span class="ti ti-headphone-alt"></span> Hotline: <a href="tel:0123456789">0123456789</a></span>
                        </li>

                        @auth
                        <li><a href="{{ route('donhang.index') }}">
                            Xem đơn hàng
                            </a>
                        </li>
                        @else
                            ...
                            <div class="row">
                                ...
                                <div class="logo_top col-lg-3 col-md-3">
                                    ...
                                    <a href="trangchu" class="logo-wrapper ">
                                        <img style="width: 90px;" src="{{ asset('images/logo.png') }}" alt="logo ">
                                    </a>
                                ...
                                <div class="search_header col-lg-6 col-md-6 col-sm-12 hidden-xs">
                                    <div class="header_searchs">
                                        <form action="{{route('search')}}" method="get" class="input-group search-bar" role="search">
                                            <input type="text" name="key" placeholder="sản phẩm... " class="input-group-field st-default-search-input search-text">
                                        ...
                                        <div class="private login_register_ hidden-sm hidden-xs">
                                            <div class="wrap_log">
                                                ...
                                                <div class="log">
                                                    ...
                                                    @else
                                                    <li><a class="text-color" href="dangnhapdangky" title="Đăng nhập">Đăng nhập/Đăng ký</a>
                                                    @endif
                                                    </ul>
